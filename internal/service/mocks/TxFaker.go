...
// TxFaker is an autogenerated mock type for the TxFaker type
type TxFaker struct {
	mock.Mock
}

// Begin provides a mock function with given fields: ctx
func (_m *TxFaker) Begin(ctx context.Context) (pgx.Tx, error) {
	ret := _m.Called(ctx)
...
func (_m *TxFaker) Commit(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *TxFaker) CopyFrom(ctx context.Context, tableName pgx.Identifier, columnNames []string, rowSrc pgx.CopyFromSource) (int64, error) {
...
func (_m *TxFaker) Exec(ctx context.Context, sql string, args ...interface{}) (pgconn.CommandTag, error) {
	var _ca []interface{}
...
func (_m *TxFaker) LargeObjects() pgx.LargeObjects {
	ret := _m.Called()
...
func (_m *TxFaker) Prepare(ctx context.Context, name string, sql string) (*pgconn.StatementDescription, error) {
...
func (_m *TxFaker) Query(ctx context.Context, sql string, args ...interface{}) (pgx.Rows, error) {
	var _ca []interface{}
	_ca = append(_ca, ctx, sql)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *TxFaker) QueryRow(ctx context.Context, sql string, args ...interface{}) pgx.Row {
	var _ca []interface{}
	_ca = append(_ca, ctx, sql)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
...
func (_m *TxFaker) Rollback(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *TxFaker) SendBatch(ctx context.Context, b *pgx.Batch) pgx.BatchResults {
	ret := _m.Called(ctx, b)
...
// NewTxFaker creates a new instance of TxFaker. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewTxFaker(t interface {
	mock.TestingT
	Cleanup(func())
}) *TxFaker {
	mock := &TxFaker{}
