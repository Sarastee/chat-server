...
import (
	...
	_ "github.com/sarastee/chat-server/statik" //nolint:golint,unused
...
func (a *App) Run() error {
	...
	go func() {
		...
		err := a.runGRPCServer()
		if err != nil {
			log.Fatalf("failure while running gRPC server")
		}
	}()
	...
	go func() {
		...
		if err != nil {
			log.Fatalf("failure while running Swagger server")
		}
	}()
